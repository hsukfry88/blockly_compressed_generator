 ...
 * @param {boolean} unusabled True if disabled.
 */
Blockly.Block.prototype.setUnusabled = function (unusabled) {
  if (this.unusabled != unusabled) {
    Blockly.Events.fire(new Blockly.Events.Change(
      this, 'unusabled', null, this.unusabled, unusabled));
    this.unusabled = unusabled;
  }
};
