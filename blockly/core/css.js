...
Blockly.Css.CONTENT = [
  ...
  '#workspaceCover {',
    ...
    'display: none;',
  '}',
  '#workspaceCoverMessage{',
    'float: right;',
    'padding: 6px; 10px',
    'line-height: 30px;',
    'border-bottom-left-radius: 15px;',
    'background-color: rgba(58,184,136,0.3);',
    'color: #072F2E;',
  '}',
  '.blocklyWidgetDiv {',
    'display: none;',
    ...
    'z-index: 999;',
  '}',
  '.blocklyUnusabled>.blocklyPathDark,',
  '.blocklyUnusabled>.blocklyPath {',
    'opacity: 0.3;',
  '}',
  '.blocklyDragging.blocklyUnusabled>.blocklyPathDark,',
  '.blocklyDragging.blocklyUnusabled>.blocklyPath {',
    'opacity: 1;',
  '}',
  '.blocklyTooltipDiv {',
